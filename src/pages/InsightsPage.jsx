      ...
      <section className="bg-gradient-to-br from-sky-50 via-sky-50 to-slate-50 border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <p className="text-sm md:text-base text-slate-600 max-w-3xl">
            A visual and written record of Medisafe Suppliers Ltd&apos;s work across Tanzania&apos;s healthcare system — field
            photos and reflections, not a product catalogue.
          </p>
        </div>
      </section>

      <section className="max-w-6xl mx-auto px-4 py-10">
        <p className="text-xs font-semibold tracking-wide text-sky-600 uppercase mb-4">Content we share</p>
